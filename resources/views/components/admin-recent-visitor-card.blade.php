                    ...
                    <dl class="-my-3 divide-y divide-gray-100 px-6 py-4 text-sm/6">
                        ...
                        <div class="flex justify-between gap-x-4 py-3">
                            ...
                            <dd class="flex items-start gap-x-2">
                                <div class="font-medium text-gray-900">{{ $visitor->created_at->format('h:i A') }}</div>
                                <div @if ($visitor->latestCheckin->check_out_time) class="rounded-md bg-red-50 px-2 py-1 text-xs font-medium text-red-700 ring-1 ring-red-600/10 ring-inset">
                                    Check out
                                    </div>
