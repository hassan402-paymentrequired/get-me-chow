  <table class="w-full text-left">
      ...
      <tbody>
          ...
          @forelse ($data['todaysOrder'] as $order)
              <tr>
          ...
          @empty
              <tr colspan="3" class="text-sm/6 text-gray-900">
                  <td class="py-5 text-center" colspan="3">No orders has being made today</td>
              </tr>
          @endforelse
          ...
          @forelse ($data['yesterdaysOrder'] as $order)
              <tr>
                  <td class="relative py-5 pr-6">
                      <div class="flex gap-x-6">
                          <svg class="hidden h-6 w-5 flex-none text-gray-400 sm:block" viewBox="0 0 20 20"
          ...
          @empty
              <tr colspan="3" class="text-sm/6 text-gray-900">
                  <td class="py-5 text-center" colspan="3">Seems impossible but No orders was made yesterday</td>
              </tr>
          @endforelse
      </tbody>
  </table>
